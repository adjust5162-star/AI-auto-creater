...
async function renderSceneClip(ffmpegPath, project, scene, destination, sceneIndex, spec) {
  ...
  const withText = buildVideoFilter(spec.width, spec.height, scene.headline, Boolean(visualAsset));
  const noText = buildVideoFilter(spec.width, spec.height, "", Boolean(visualAsset));
